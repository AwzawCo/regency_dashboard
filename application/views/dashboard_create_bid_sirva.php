                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $tableHeaders['reservationNum'] ? $tableHeaders['reservationNum'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['arrivalDate'] ? $tableHeaders['arrivalDate'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['minimumStay'] ? $tableHeaders['minimumStay'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['numOccupants'] ? $tableHeaders['numOccupants'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['desiredLocation'] ? $tableHeaders['desiredLocation'] : "Not Specified"; ?></td>
              ...
              <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $tableHeaders['pets'] ? $tableHeaders['pets'] : "Not Specified"; ?></td>
