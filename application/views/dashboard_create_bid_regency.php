                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $tableHeaders['id'] ? $tableHeaders['id'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['numBedrooms'] ? $tableHeaders['numBedrooms'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['numBathrooms'] ? $tableHeaders['numBathrooms'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['moveInDate'] ? $tableHeaders['moveInDate'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['moveOutDate'] ? $tableHeaders['moveOutDate'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['address'] ? $tableHeaders['address'] : "Not Specified"; ?></td>
              ...
              <table class="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $tableHeaders['numPets'] ? $tableHeaders['numPets'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['typeWeightBreed'] ? $tableHeaders['typeWeightBreed'] : "Not Specified"; ?></td>
                      <td><?php echo $tableHeaders['specialRequest'] ? $tableHeaders['specialRequest'] : "Not Specified"; ?></td>
...
<div class="container">
    ...
    <?php
      $attributes = array('id' => 'bid_form_regency',
